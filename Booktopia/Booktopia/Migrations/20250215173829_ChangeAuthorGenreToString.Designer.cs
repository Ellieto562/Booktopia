...
namespace Booktopia.Migrations
{
    ...
    [Migration("20250215173829_ChangeAuthorGenreToString")]
    partial class ChangeAuthorGenreToString
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Booktopia.Models.Entities.Book", b =>
                {
                    b.HasOne("Booktopia.Models.Entities.Author", null)
                        .WithMany("Books")
                        .HasForeignKey("AuthorId");

                    b.HasOne("Booktopia.Models.Entities.Genre", null)
                        .WithMany("Books")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Booktopia.Models.Entities.Users", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
